					...
					<div class="span9">
						...
						<br />
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="${pageContext.request.contextPath }/bul/addUpBul" method="post">
									<fieldset>
									
										<input type="hidden" id="id" name="id" value="${UpBul.id }">
										<div class="control-group">											
											<label class="control-label" for="username">公告标题</label>
											<div class="controls">
												<input type="text" class="input-medium disabled" id="btitle" name="btitle" value="${UpBul.btitle }" />
