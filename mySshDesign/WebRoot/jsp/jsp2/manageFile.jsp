				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						...
						<a data-toggle="dropdown" class="dropdown-toggle " href="#">
							${user.username } &nbsp;<p:findPower pid="${user.power}"></p:findPower><b class="caret"></b>							
						</a>
			...
			<div class="span9">
				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
							...
							<tbody>
								<c:forEach items="${comlist}" var="com">
									<tr>
										...
										<td class="action-td">
											<p:doPower value="用户:下载"><a href="${pageContext.request.contextPath }/com/download?cid=${com.cid}" class="btn btn-small btn-warning" >
												<i class="icon-ok"> 下载</i>								
											</a></p:doPower>	
											<p:doPower value="删除文件"><a href="${pageContext.request.contextPath }/com/delCom?cid=${com.cid }" class="btn btn-small" >
						...
						<ul class="pager">
							<c:if test=""></c:if>
						  <li class="previous <c:if test="${page==1}">disabled</c:if>" ><a href="<c:if test="${page!=1}">${pageContext.request.contextPath }/com/showFiles?count=${page-1}</c:if>#">&larr; 上一页</a></li>
						  <li class="next <c:if test="${page==total}">disabled</c:if>"><a href="<c:if test="${page!=total}">${pageContext.request.contextPath }/com/showFiles?count=${page+1}</c:if>#">下一页 &rarr;</a></li>
						</ul>
