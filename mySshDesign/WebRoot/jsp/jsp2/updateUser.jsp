					...
					<div class="span9">
						...
						<br />
							...
							<div class="tab-content">
							 ...
							 <form  class="form-horizontal" action="${pageContext.request.contextPath }/user/addUpUser" method="post">
									
										<input id="id" type="hidden" name="id" value="${UpUser.id }">
										<div class="control-group">											
											<label class="control-label" for="username">用户名</label>
											<div class="controls">
												<input type="text" class="input-medium disabled" id="username" name="username" readonly="readonly" value="${UpUser.username }" onblur="namef()" />
										...
										<div class="control-group">											                         
											...
											<div class="controls">
												<input type="text" class="input-medium" id="email" name="email" value="${UpUser.email }" onblur="emailf()" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" id="password" name="password" value="${UpUser.password }" onblur="passf()" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" id="password2" value="${UpUser.password }" onblur="passf()"/>
