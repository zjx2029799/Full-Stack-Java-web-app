				...
				<div class="widget widget-table">
					...
					<div class="widget-content">
						...
						<table class="table table-striped table-bordered">
							<thead>
								<tr>
									<th style="width: 60px; height: 2px">公告id</th>
									<th style="width: 80px; ">发布日期</th>
									<th style="width: 80px; ">公告标题</th>
									<th style="width: 100px; ">公告内容</th>
							...
							<tbody>
								<c:forEach items="${blist}" var="b">
									<tr>
										...
										<td>${user.username}</td>
										<td class="action-td">
											<p:doPower value="用户:修改"><a href="${pageContext.request.contextPath }/bul/updateBul?id=${b.id}" class="btn btn-small btn-warning" >
												<i class="icon-ok"> 修改</i>								
											</a></p:doPower>	
											<p:doPower value="用户:删除"><a href="${pageContext.request.contextPath }/bul/delBul?id=${b.id }" class="btn btn-small" >
